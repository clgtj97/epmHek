...
<div className="backgroundImgTre columns slideFirst has-text-centered position-relative shadow">
          ...
          <div className="column overlay " style={overlayStyle}>
            <div className="columns is-mobile is-centered" >
              <div className="column is-half" style={titleBox}>
                <h2 className="slideTwoTextT title is-1 has-text-light">
                  Olvida las filas y esperas.
                </h2>
                <p className="slideTwoTextT title is-3 has-text-light">
                  En Express Parts Mexico, llevamos la parte de agencia directamente a tu puerta gracias a nuestro servicio de expertos en autopartes. Comodidad y eficiencia, solo para ti. 
                </p>
              </div>
            </div>
          </div>
