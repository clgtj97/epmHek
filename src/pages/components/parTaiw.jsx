...
<div className="backgroundImgFor columns slideFirst has-text-centered position-relative shadow">
            ...
            <div className="columns is-mobile is-centered" >
              <div className="column is-half" style={titleBox}>
                <p className="slideTwoTextT title is-2 has-text-light">
                  Descubre calidad a buen precio con nuestras partes nuevas taiwanesas en Express Parts Mexico.
                </p>
                <p className="slideTwoTextT title is-5 has-text-light">
                 Con disponibilidad rápida para una variedad de modelos, tanto nuevos como pasados, hacemos que mantener tu vehículo sea repido y sencillo
                </p>
              </div>
            </div>
          </div>
